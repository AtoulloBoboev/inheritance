 ...
 *
 * Затем, создайте класс Преподаватель (англ. Teacher).
...
public class Main {
    public static void main(String[] args) {
        Student student = new Student("John", "A-17");
        Teacher teacher = new Teacher("Jamaica", "Mathematics");

        System.out.println(student.getNameOfGroup());
        System.out.println(teacher.getNameOfSubject());
